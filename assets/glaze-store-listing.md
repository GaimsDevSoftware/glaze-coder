# Glaze Store listing copy

Ready-to-paste text for the store listing. No fancy dashes, plain wording. Pick the
tagline you like and use the short and long descriptions as is or trim to fit.

## Taglines (pick one)

1. Build Glaze apps with your own Claude, for free.
2. Make Mac apps from Claude Code. No Glaze credits.
3. Your Claude builds the app, Glaze ships it. Zero credits.
4. Build, edit and ship Glaze apps without spending credits.
...
Raycast. Describe the app you want in plain words and Claude Code writes the code, then
build and run it on your Mac. When it is ready, publish it to the Glaze Store.

Works on macOS (Tahoe or newer) on Apple Silicon, with Glaze and Claude Code installed.
